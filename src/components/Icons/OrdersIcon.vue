<template>
  <svg style="width: 20px; height: 20px" height="20" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
    <g fill="none">
      <path
        ...
        fill="#4F566B"
        class="db-SideNav-iconFill--primary"
      ></path>
      <path
        ...
        fill="#A3ACB9"
        class="db-SideNav-iconFill--secondary"
      ></path>
    </g>
  </svg>
</template>
