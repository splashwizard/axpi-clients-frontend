<template>
    <div>
        ...
        <a-modal :centered="true" :width="700" :mask-closable="false"
                 ok-text="Save"
                 v-model="shouldShowModal" title="Upload CSV" @ok="attemptParseAndSave">
                ...
                Papa.parse(this.fileList[0], {
                    ...
                    complete: function (results) {
                        ...
                        _.each(results.data, function (result) {
                            ...
                            axios.post(window.API_BASE + '/addresses', address).then(r => {
                                totalSaved++;
                                ...
                                vm.orderLocal.delivery_locations.push({
                                    ...
                                    date_shipped: moment(result['Date Shipped'], 'YYYY-MM-DD').isValid() ? moment(result['Date Shipped'], 'YYYY-MM-DD') : null,
