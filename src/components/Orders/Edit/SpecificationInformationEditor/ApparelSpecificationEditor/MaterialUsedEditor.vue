                        ...
                        <a-col :span="12">
                            <a-form layout="vertical">
                                <a-form-item label="Material">
                                    <a-cascader size="large" v-model="material.material_type"
                                            :options="materialTypeOptions" @change="forceRefresh">
                                    </a-cascader>
                                </a-form-item>

                                <a-checkbox @change="forceRefresh">
                                    Organic?
                                </a-checkbox>

                                <a-form-item label="Percentage">
                                    <a-input v-model="material.percentage"
                                             @blur="forceRefresh"
                                            type="number" :min="0" :max="100" size="large"></a-input>
                                </a-form-item>

                                <a-form-item label="Country Of Origin">
                                    <a-select show-search
                                            v-model="material.country_of_origin" @change="forceRefresh" size="large">
