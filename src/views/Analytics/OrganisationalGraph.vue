<template>
  <div id="organisational-graph" ref="organisational-graph"></div>
</template>
...
export default {
  ...
  methods: {
    initGraph() {
      // const container = document.getElementById('organisational-graph');
      const container = this.$refs["organisational-graph"];
      ...
      const initGraph = (data) => {
        ...
        graph = new G6.TreeGraph({
          container: "organisational-graph",
          ...defaultConfig,
          ...config,
          plugins: [tooltip],
        });
