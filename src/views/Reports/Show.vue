<template>
  <div class="reports">
    ...
    <div v-if="reportId === 'roche'">
      <iframe src='https://flo.uri.sh/story/898435/embed' title='Interactive or visual content' frameborder='0'
    ...
    <!-- Summary -->
    <div v-if="reportId === 'summary'">
      <iframe src='https://flo.uri.sh/story/765783/embed' title='Interactive or visual content' frameborder='0'
              scrolling='no' style='width:100%;height:600px;'
              sandbox='allow-same-origin allow-forms allow-scripts allow-downloads allow-popups allow-popups-to-escape-sandbox allow-top-navigation-by-user-activation'></iframe>
      <div style='width:100%!;margin-top:4px!important;text-align:right!important;'></div>
    </div>
