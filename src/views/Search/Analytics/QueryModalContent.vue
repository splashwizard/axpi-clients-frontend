  ...
  <div>
    ...
    <a-card class="mt-2">
      <div class="relative" style="width: 100%">
        ...
        <p>
          Positions of the clicks performed on results displayed for "jacket"
        </p>
      </div>
      <div class="d-flex" style="width: 100%;position: relative">
        <div v-for="key in clickKeys" :key="key" class="click-card" style="text-align:center">
          <div class="ch-100" :class="clickGradient(key)">
          </div>
