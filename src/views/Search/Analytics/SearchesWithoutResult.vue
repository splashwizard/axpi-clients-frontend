    ...
    <a-card :bodyStyle="{ padding: 0 }" class="mt-2">
      <div class="p-6">
        <a-row type="flex" justify="space-between" class="rule-row">
          <h4>Searches without Results</h4>
          <a-input
            class="search-term"
            :value="searchTerm"
...
<script>
import SearchesWithoutResultTable from "./SearchesWithoutResultTable";
...
export default {
  name: "SearchesWithoutResult",
  props: [],
  components: { SearchesWithoutResultTable },
  data() {
    return {
      option: "4_weeks",
      chartData: [],
